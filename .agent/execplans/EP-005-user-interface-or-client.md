...
- [x] M5: Results page + CE record download - 2026-06-27 - `pnpm --filter web test:e2e -- happy_path.spec.ts` passed after the e2e runner applies API migrations and cleans up the local API process tree.
